...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      // Navigation will happen via the redirect check above
    } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-foreground">StarBags</h1>
          <p className="text-muted-foreground mt-2">Premium Bags & Accessories</p>
        </div>
              ...
              <TabsContent value="login" className="mt-0">
                ...
                <div className="mt-6 p-4 rounded-lg bg-muted/50 border border-border">
                  ...
                  <div className="space-y-1 text-sm text-muted-foreground">
                    <p><span className="font-medium">Admin:</span> admin@starbags.com / admin123</p>
